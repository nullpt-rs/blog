...
![](/posts/anatomy-of-a-supreme-bot-part-3/1.png)
    <figcaption>The cookie-sub passed to checkout.json</figcaption>
</figure>
<figure className="kg-card kg-image-card kg-card-hascaption">
![](/posts/anatomy-of-a-supreme-bot-part-3/2-1.png)
...
<figure className="kg-card kg-image-card kg-card-hascaption">
![](/posts/anatomy-of-a-supreme-bot-part-3/4-1.png)
...
<figure className="kg-card kg-image-card kg-card-hascaption">
![](/posts/anatomy-of-a-supreme-bot-part-3/5-1.png)
...
<figure className="kg-card kg-image-card kg-card-hascaption">
![](/posts/anatomy-of-a-supreme-bot-part-3/6-1.png)
